...
namespace ERPAPI.Migrations
{
    ...
    [Migration("20200326184016_Add_RegimenFacturacion_ProformaInvoice")]
    partial class Add_RegimenFacturacion_ProformaInvoice
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERPAPI.Models.Contrato", b =>
                {
                    ...
                    b.Property<double>("Finaciar");

                    b.Property<long>("IdEmpleado");

                    b.Property<double>("Impuesto");

                    b.Property<double>("InteresesFinaciar");

                    b.Property<double>("InteresesMora");

                    b.Property<string>("NombreEmpleado");

                    b.Property<string>("NombreEstado");

                    b.Property<double>("PagoPorMora");

                    b.Property<int>("Plazo");

                    b.Property<double>("PrimaMonto");

                    b.Property<DateTime>("Proxima_fecha_de_pago");

                    b.Property<double>("SaldoActual");

                    b.Property<double>("SaldoCredito");

                    b.Property<double>("Saldo_Contrato");

                    b.Property<double>("SinFinaciar");

                    b.Property<double>("Tasa_de_Interes");

                    b.Property<double>("TotalContrato");
                    ...
                    b.Property<double>("ValorContado");

                    b.Property<double>("ValorCuota");

                    b.Property<double>("ValorPrima");
            ...
            modelBuilder.Entity("ERPAPI.Models.Contrato_detalle", b =>
                {
                    ...
                    b.Property<double>("FundingInterestRate");
            ...
            modelBuilder.Entity("ERPAPI.Models.Contrato_plan_pagos", b =>
                {
                    ...
                    b.HasIndex("Contrato_movimientosId");
            ...
            modelBuilder.Entity("ERPAPI.Models.FundingInterestRate", b =>
                {
                    ...
                    b.Property<int>("GrupoConfiguracionInteresesId");
                    ...
                    b.HasIndex("GrupoConfiguracionInteresesId");
            ...
            modelBuilder.Entity("ERPAPI.Models.GrupoConfiguracionIntereses", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("GrupoConfiguracionIntereses");
                });
            ...
            modelBuilder.Entity("ERPAPI.Models.InventoryTransferLine", b =>
                {
                    ...
                    b.Property<double>("CantidadRecibida");
            ...
            modelBuilder.Entity("ERPAPI.Models.KardexViale", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ERPAPI.Models.Moras", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("MaxDias");

                    b.Property<int>("MinDias");

                    b.Property<long?>("MorasId");
            ...
            modelBuilder.Entity("ERPAPI.Models.MotivosAjuste", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ERPAPI.Models.Product", b =>
                {
                    ...
                    b.Property<bool>("FlagConsignacion");
                    ...
                    b.Property<decimal?>("Valor_prima")
                        .ValueGeneratedOnAddOrUpdate();
            ...
            modelBuilder.Entity("ERPAPI.Models.ProformaInvoice", b =>
                {
                    ...
                    b.Property<string>("NumeroExonerado");

                    b.Property<string>("NumeroOC");

                    b.Property<string>("NumeroSAG");
            ...
            modelBuilder.Entity("ERPAPI.Models.PurchaseOrderLine", b =>
                {
                    ...
                    b.Property<double?>("QtyAuthorized");
            ...
            modelBuilder.Entity("ERPAPI.Models.RegistroGastos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ERPAPI.Models.TipoGastos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ERPAPI.Models.Branch", b =>
                {
                    ...
                    b.HasOne("ERPAPI.Models.Employees", "Employee")
                        .WithMany()
            ...
            modelBuilder.Entity("ERPAPI.Models.Contrato_plan_pagos", b =>
                {
                    ...
                    b.HasOne("ERPAPI.Models.Contrato_movimientos", "Contrato_movimientos")
                        .WithMany()
                        .HasForeignKey("Contrato_movimientosId");
                });
            ...
            modelBuilder.Entity("ERPAPI.Models.FundingInterestRate", b =>
                {
                    b.HasOne("ERPAPI.Models.GrupoConfiguracionIntereses", "grupoConfiguracionIntereses")
                        .WithMany()
                        .HasForeignKey("GrupoConfiguracionInteresesId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("ERPAPI.Models.RegistroGastos", b =>
                {
                    ...
                    b.HasOne("ERPAPI.Models.TipoGastos", "TipoGastos")
                        .WithMany()
